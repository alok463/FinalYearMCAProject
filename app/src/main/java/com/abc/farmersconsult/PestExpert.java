...
public class PestExpert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pest_expert);
        ...
        spinner.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item,CountryData.Qualifications));
    ...
    private void saveAccount() {
        ...
        final String code = getIntent().getStringExtra("PestExpert");
        final String Qualification=CountryData.Qualifications[spinner.getSelectedItemPosition()];
            ...
            if (imageHoldUri != null) {
                ...
                ImageStore.putFile(imageHoldUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        mUserRef.child("Qualification").setValue(Qualification);
                        mUserRef.child("Image").setValue(imageUrl.toString());
                        progressDialog.dismiss();
                        Intent moveToDash=new Intent(PestExpert.this, Dashboard.class);
                ...
                Toast.makeText(PestExpert.this, "Please select the profile pic", Toast.LENGTH_LONG).show();

            }
        } else {
            Toast.makeText(PestExpert.this, "Please enter Status and Username", Toast.LENGTH_LONG).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==PLACE_PICKER_REQUEST){
            if( resultCode==RESULT_OK) {
                ...
                Place place= PlacePicker.getPlace(PestExpert.this,data);
    ...
    public void goPlacePicker(View view){
        ...
        try {
            ...
            startActivityForResult(builder.build(PestExpert.this),PLACE_PICKER_REQUEST);
